...
const makeHand = (
  ...
  return {
    id,
    ...baseline,
    note: '이 값은 솔버 출력이 아니라 초보 학습용으로 단순화한 기준선입니다.',
    exploit:
...
export const gtoSpots: GtoSpot[] = [
  ...
  },
  {
    ...
    hands: makeHands({
      AJs: {
        ...
        call: 22,
        fold: 16,
        note: 'AJs는 UTG에서도 열 수 있지만, 뒤 포지션 압박을 고려해 버튼보다 낮은 빈도로 봅니다.',
        exploit:
  ...
  },
  {
    ...
    position: '컷오프',
    description:
      '컷오프에서 모두 폴드된 상황입니다. 버튼보다 조금 타이트하지만 스틸 가치는 충분히 있습니다.',
    hands: makeHands({
      AJs: {
        raise: 68,
        call: 22,
      ...
      K9o: {
        ...
        fold: 76,
        exploit:
          '뒤 포지션이 수동적일 때만 일부 섞고, 공격적인 버튼이 있으면 폴드 쪽으로 둡니다.',
      },
    }),
  },
  {
    ...
    position: '스몰블라인드',
    description:
      '스몰블라인드에서 빅블라인드만 남은 상황입니다. 포지션은 없지만 상대가 한 명이라 넓은 공격이 가능합니다.',
    hands: makeHands({
      AJs: {
        raise: 72,
        call: 18,
        fold: 10,
        note: 'AJs는 스몰블라인드에서 강하게 열 수 있는 핸드입니다.',
        exploit:
      ...
      K9o: {
        ...
        fold: 50,
        exploit:
          '상대가 패시브하면 오픈 후보가 되지만, 자주 3-bet하면 낮춥니다.',
      },
    }),
  },
  {
  ...
  },
  {
    ...
    hands: makeHands({
      AJs: {
        ...
        call: 58,
        fold: 18,
        note: 'AJs는 콜과 일부 3-bet을 섞을 수 있지만, 버튼 상대보다 신중하게 봅니다.',
        exploit:
          '컷오프가 넓게 열면 3-bet을 늘리고, 타이트하면 콜과 폴드 쪽으로 낮춥니다.',
      },
      K9o: {
        raise: 6,
        call: 20,
        fold: 74,
        exploit:
          '상대 오픈이 넓고 사이즈가 작을 때만 일부 방어하고, 기본은 폴드에 가깝습니다.',
      },
    }),
  },
  {
